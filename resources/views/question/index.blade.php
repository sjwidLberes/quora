                        ...
                        <div class="feed-item">
                            <div class="feed-item-inner">
                                <div class="feed-avatar">
                                    <a href="{{route('profile.question',$question->user->id)}}"><img src="{{$question->user->avatar}}" alt=""></a>
                                ...
                                <div class="feed-main">
                                    ...
                                    <div class="feed-meta">
                                        <div class="feed-meta-panel">
                                            <a href="#" class="meta-item"><i class="fa fa-comment fa-icon-sm"></i>{{$question->answer_count}}条回答</a>
                                            <a href="#" class="meta-item"><i class="fa fa-star fa-icon-sm"></i>{{$question->follower_count}}人关注</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
